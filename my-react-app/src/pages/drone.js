...
function Drone_Page() {
  ...
  return (
    ...
    <main>
        ...
        <div class="pic"><img src="/img/drone/1.png"/></div>
        <p>The system was modeled as the following</p>
        <div class="pic"><img src="/img/drone/2.png"/></div>
        ...
        <div class="pic"><img src="/img/drone/3.png"/></div>
        ...
        <div class="pic"><img src="/img/drone/4.png"/></div>
        ...
        <div class="pic"><img src="/img/drone/6.png"/></div>
        ...
        <div class="pic"><img src="/img/drone/7.png"/></div>
